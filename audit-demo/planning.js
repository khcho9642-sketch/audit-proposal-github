(function (root, factory) {
  ...
  function buildPlan(dataset) {
    ...
    return {
      ...
      synthetic: true,
      notice: '가상기업의 재무제표 계정 → 조서 분류 → 수령자료 연결을 보여주는 계획 데모입니다. 조서번호는 자체 시연용이며 한공회 표준번호가 아닙니다. 매출액은 가상 원장 합계이고 다른 금액은 표 간 연결을 위한 가정값입니다. 전체 재무제표·주석의 회계기준 준수나 모든 영역의 감사 완료를 뜻하지 않습니다.',
